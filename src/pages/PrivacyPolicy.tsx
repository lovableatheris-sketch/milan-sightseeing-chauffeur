...
const PrivacyPolicy = () => {
    ...
    const content = {
        it: {
            ...
            seoTitle: "Informativa sulla Privacy | Nexitus",
            seoDesc: "Informativa sulla privacy di Nexitus. Scopri come raccogliamo, utilizziamo e proteggiamo i tuoi dati personali.",
            lastUpdate: "Ultimo aggiornamento: 1 Marzo 2026",
            sections: [
                { title: "1. Titolare del Trattamento", text: "Il titolare del trattamento dei dati personali è Nexitus - Sightseeing di Thomas Tagliatti, con sede a Milano, Italia. E-mail: thomastagliatti2022@gmail.com. Telefono: +39 389 143 0907." },
        ...
        en: {
            ...
            seoTitle: "Privacy Policy | Nexitus",
            seoDesc: "Nexitus privacy policy. Learn how we collect, use and protect your personal data.",
            lastUpdate: "Last updated: March 1, 2026",
            sections: [
                { title: "1. Data Controller", text: "The data controller is Nexitus - Sightseeing di Thomas Tagliatti, based in Milan, Italy. Email: thomastagliatti2022@gmail.com. Phone: +39 389 143 0907." },
        ...
        pt: {
            ...
            seoTitle: "Política de Privacidade | Nexitus",
            seoDesc: "Política de privacidade da Nexitus. Saiba como coletamos, usamos e protegemos seus dados pessoais.",
            lastUpdate: "Última atualização: 1 de Março de 2026",
            sections: [
                { title: "1. Controlador de Dados", text: "O controlador de dados é Nexitus - Sightseeing di Thomas Tagliatti, com sede em Milão, Itália. E-mail: thomastagliatti2022@gmail.com. Telefone: +39 389 143 0907." },
        ...
        fr: {
            ...
            seoTitle: "Politique de Confidentialité | Nexitus",
            seoDesc: "Politique de confidentialité de Nexitus. Découvrez comment nous collectons et protégeons vos données.",
            lastUpdate: "Dernière mise à jour: 1er Mars 2026",
            sections: [
                { title: "1. Responsable du Traitement", text: "Le responsable du traitement est Nexitus - Sightseeing di Thomas Tagliatti, Milan, Italie. Email: thomastagliatti2022@gmail.com." },
    ...
    return (
        <div className="min-h-screen bg-background">
            <SEOHead title={c.seoTitle} description={c.seoDesc} keywords="privacy policy, informativa privacy, GDPR" canonicalUrl="https://nexitus.it/privacy-policy" />
            <Header />
