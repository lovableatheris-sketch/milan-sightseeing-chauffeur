...
const TermsConditions = () => {
    ...
    const content = {
        it: {
            ...
            seoTitle: "Termini e Condizioni | Nexitus",
            seoDesc: "Termini e condizioni del servizio NCC Nexitus. Condizioni di prenotazione, cancellazione, pagamento e responsabilità.",
            lastUpdate: "Ultimo aggiornamento: 1 Marzo 2026",
            sections: [
                { title: "1. Informazioni Generali", text: "I presenti Termini e Condizioni regolano l'utilizzo dei servizi offerti da Nexitus - Sightseeing di Thomas Tagliatti, servizio di Noleggio Con Conducente (NCC) autorizzato con sede a Milano, Italia.\n\nUtilizzando i nostri servizi o il nostro sito web, accetti integralmente i presenti termini." },
                { title: "2. Servizi Offerti", text: "Nexitus offre i seguenti servizi:\n\n• Transfer aeroportuali (Malpensa, Linate, Bergamo Orio al Serio)\n• Tour turistici privati (Lago di Como, Lago Maggiore, San Siro)\n• Disposizioni orarie aziendali (2h, 4h, 8h)\n• Viaggi a lunga distanza in tutta Italia\n• Servizi corporate B2B\n\nTutti i servizi sono forniti con veicoli Mercedes di lusso e autisti professionali autorizzati." },
                ...
                { title: "7. Responsabilità di Nexitus", text: "Nexitus si impegna a:\n\n• Fornire veicoli in perfette condizioni, sanificati e climatizzati\n• Garantire autisti professionali, puntuali e cortesi\n• Monitorare i voli in tempo reale per adeguare l'orario di prelievo\n• Rispettare i prezzi concordati al momento della prenotazione\n\nNexitus non è responsabile per ritardi causati da traffico, condizioni meteorologiche avverse, incidenti stradali o altre cause di forza maggiore." },
                { title: "8. Bagagli", text: "• Ogni veicolo ha una capacità massima di bagagli\n• Bagagli fuori misura o in quantità eccedente devono essere comunicati in fase di prenotazione\n• Nexitus non è responsabile per danni a bagagli fragili non adeguatamente protetti" },
                { title: "9. Proprietà Intellettuale", text: "Tutti i contenuti del sito web (testi, immagini, logo, grafica) sono di proprietà di Nexitus e protetti dalla legge sul diritto d'autore. È vietata la riproduzione senza autorizzazione scritta." },
        ...
        en: {
            ...
            seoTitle: "Terms and Conditions | Nexitus",
            seoDesc: "Terms and conditions for Nexitus NCC service. Booking, cancellation, payment and liability conditions.",
            lastUpdate: "Last updated: March 1, 2026",
            sections: [
                { title: "1. General Information", text: "These Terms and Conditions govern the use of services offered by Nexitus - Sightseeing di Thomas Tagliatti, an authorized NCC (Hire with Driver) service based in Milan, Italy." },
                ...
                { title: "5. Liability", text: "Nexitus provides sanitized luxury Mercedes vehicles with professional drivers. We are not liable for delays caused by traffic, weather, accidents or force majeure." },
        ...
        pt: {
            ...
            seoTitle: "Termos e Condições | Nexitus",
            seoDesc: "Termos e condições do serviço NCC Nexitus. Condições de reserva, cancelamento, pagamento e responsabilidade.",
            lastUpdate: "Última atualização: 1 de Março de 2026",
            sections: [
                { title: "1. Informações Gerais", text: "Estes Termos e Condições regem o uso dos serviços oferecidos pela Nexitus - Sightseeing di Thomas Tagliatti, serviço NCC autorizado com sede em Milão, Itália." },
        ...
        fr: {
            ...
            seoTitle: "Conditions Générales | Nexitus",
            seoDesc: "Conditions générales du service VTC Nexitus. Réservation, annulation, paiement et responsabilité.",
            lastUpdate: "Dernière mise à jour: 1er Mars 2026",
            sections: [
                { title: "1. Informations Générales", text: "Les présentes Conditions Générales régissent l'utilisation des services offerts par Nexitus - Sightseeing di Thomas Tagliatti, service VTC autorisé basé à Milan, Italie." },
    ...
    return (
        <div className="min-h-screen bg-background">
            <SEOHead title={c.seoTitle} description={c.seoDesc} keywords="termini condizioni, terms conditions" canonicalUrl="https://nexitus.it/termini-condizioni" />
            <Header />
