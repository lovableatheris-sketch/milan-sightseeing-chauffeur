      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <Card
            ...
            className="p-10 md:p-16 rounded-2xl shadow-card hover:shadow-elegant transition-all duration-300 hover:scale-[1.01] bg-card border border-border cursor-pointer group"
          >
