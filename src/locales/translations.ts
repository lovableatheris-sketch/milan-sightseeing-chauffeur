export const translations = {
  pt: {
    ...
    reviews: {
      subtitle: "DEPOIMENTOS DOS CLIENTES",
      title: "O Que Nossos Clientes Dizem",
      description: "Descubra as experiências de nossos clientes satisfeitos de todo o mundo",
      ...
      review1: "Serviço excepcional! Motorista pontual e profissional. O carro estava impecável e a viagem de Malpensa ao centro de Milão foi muito confortável. Recomendo muito!",
      review2: "Experiência incrível! O motorista estava nos esperando no aeroporto com uma placa. A Mercedes era luxuosa e limpa. Serviço perfeito para nossa viagem de negócios.",
      review3: "Excelente serviço de transfer! O motorista falava francês e nos deu dicas valiosas sobre Milão. Preço fixo, sem surpresas. Eu recomendo!",
      review4: "Serviço impecável! O motorista foi muito atencioso e o carro era lindo. O passeio ao Lago di Como foi inesquecível. Super recomendo para brasileiros visitando Milão!",
      review5: "Serviço muito profissional! Pontual, limpo e confortável. O motorista foi muito simpático. Perfeito para viagens de negócios a Milão.",
      review6: "Usei o serviço para uma viagem de trabalho. Pontualidade perfeita, carro limpíssimo e motorista muito cordial. Preços transparentes e sem custos adicionais. Top!",
    },
  },
  en: {
    header: {
    ...
    reviews: {
      ...
      description: "Discover the experiences of our satisfied clients from around the world",
      ...
      review1: "Exceptional service! Punctual and professional driver. The car was impeccable and the journey from Malpensa to Milan city center was very comfortable. Highly recommended!",
      review2: "Amazing experience! The driver was waiting for us at the airport with a sign. The Mercedes was luxurious and clean. Perfect service for our business trip.",
      review3: "Excellent transfer service! The driver spoke French and gave us valuable tips about Milan. Fixed price, no surprises. I recommend!",
      review4: "Impeccable service! The driver was very attentive and the car was beautiful. The trip to Lake Como was unforgettable. Highly recommend for anyone visiting Milan!",
      review5: "Very professional service! Punctual, clean and comfortable. The driver was very friendly. Perfect for business trips to Milan.",
      review6: "Used the service for a business trip. Perfect punctuality, spotless car and very friendly driver. Transparent prices and no extra costs. Top!",
    },
  },
  it: {
    header: {
    ...
    reviews: {
      subtitle: "TESTIMONIANZE DEI CLIENTI",
      title: "Cosa Dicono i Nostri Clienti",
      description: "Scopri le esperienze dei nostri clienti soddisfatti da tutto il mondo",
      reviewCount: "47 recensioni",
      ...
      review1: "Servizio eccezionale! Autista puntuale e professionale. L'auto era impeccabile e il viaggio da Malpensa al centro di Milano è stato molto confortevole. Consiglio vivamente!",
      review2: "Esperienza fantastica! L'autista ci aspettava all'aeroporto con un cartello. La Mercedes era lussuosa e pulita. Servizio perfetto per il nostro viaggio di lavoro.",
      review3: "Ottimo servizio di trasferimento! L'autista parlava francese e ci ha dato preziosi consigli su Milano. Prezzo fisso, nessuna sorpresa. Lo consiglio!",
      review4: "Servizio impeccabile! L'autista è stato molto attento e l'auto era bellissima. Il tour al Lago di Como è stato indimenticabile. Super consigliato!",
      review5: "Servizio molto professionale! Puntuale, pulito e confortevole. L'autista era molto gentile. Perfetto per viaggi di lavoro a Milano.",
      review6: "Ho usato il servizio per un viaggio di lavoro. Puntualità perfetta, auto pulitissima e autista molto cordiale. Prezzi trasparenti e nessun costo aggiuntivo. Top!",
    },
  },
  fr: {
    header: {
    ...
    reviews: {
      ...
      description: "Découvrez les expériences de nos clients satisfaits du monde entier",
      reviewCount: "47 avis",
      ...
      review1: "Service exceptionnel! Chauffeur ponctuel et professionnel. La voiture était impeccable et le trajet de Malpensa au centre de Milan était très confortable. Je recommande vivement!",
      review2: "Expérience incroyable! Le chauffeur nous attendait à l'aéroport avec une pancarte. La Mercedes était luxueuse et propre. Service parfait pour notre voyage d'affaires.",
      review3: "Excellent service de transfert! Le chauffeur parlait français et nous a donné de précieux conseils sur Milan. Prix fixe, pas de surprises. Je recommande!",
      review4: "Service impeccable! Le chauffeur était très attentionné et la voiture était magnifique. L'excursion au Lac de Côme était inoubliable. Je recommande vivement!",
      review5: "Service très professionnel! Ponctuel, propre et confortable. Le chauffeur était très sympathique. Parfait pour les voyages d'affaires à Milan.",
      review6: "J'ai utilisé le service pour un voyage d'affaires. Ponctualité parfaite, voiture impeccable et chauffeur très cordial. Prix transparents et pas de frais supplémentaires. Top!",
    },
  },
};
